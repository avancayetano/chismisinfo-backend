...
def make_control_df():
    csv_file_paths = [
        "../data/five-control-data/control_baguio.csv",
        "../data/five-control-data/control_scandal.csv",
        "../data/five-control-data/control_quarantine.csv",
        "../data/five-control-data/control_ladder.csv",
        "../data/five-control-data/control_other.csv",
    ]
    ...
    tweets_df.to_csv("../data/control_dataset_testing.csv")
